...
export const DI = {
  ...
  /* Client activity: a pulse over a device, to read as "what the apps reported"
     rather than as another request log (the flat lines above). */
  activityLog: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="13" rx="2" /><path d="M6 11h3l1.5-3 2 6 1.5-3h3" /><path d="M9 20h6" /></svg>,
