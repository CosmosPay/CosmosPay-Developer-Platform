...
export function OrgStep({ ob, name, setName, industry, setIndustry }) {
  return (
    <div className="ob-fade">
      ...
      <label className="ob-field-l">{ob.nameLabel}</label>
      <input className="ob-input" value={name} placeholder={ob.namePlaceholder} autoFocus onChange={(e) => setName(e.target.value)} />
