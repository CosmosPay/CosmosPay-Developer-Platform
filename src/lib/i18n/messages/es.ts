...
export default {
  ...
  landing: {
    ...
    api: {
      ...
      docsDesc: "Hecha por desarrolladores, para desarrolladores. Guías interactivas, referencias detalladas de la API y SDK para todos los lenguajes que te gustan.",
      sdkBtns: {
        node: "SDK de Node.js",
