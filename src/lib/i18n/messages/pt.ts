...
export default {
  ...
  landing: {
    ...
    api: {
      ...
      docsDesc: "Feita por desenvolvedores, para desenvolvedores. Guias interativos, referências detalhadas de API e SDKs para todas as linguagens que você ama.",
      sdkBtns: {
        node: "SDK Node.js",
        python: "SDK Python",
        go: "SDK Go",
  ...
  dash: {
    ...
    modals: {
      ...
      key: {
        ...
        scopeResources: { payments: "Pagamentos", webhooks: "Webhooks", products: "Produtos", customers: "Clientes" },
